...
// node_modules/@strapi/content-releases/dist/admin/chunks/index-TSoOtDGF.mjs
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en-B2EeDoOz-J5EKOLMO.js");
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-nCn9ijZP-XL6HJJST.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-BDN7ia8_-UUD5AVZG.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-S1ccDSwp-WQCM2UTE.js");
          return {
...
//# sourceMappingURL=chunk-TNS4RZ46.js.map
