...
// node_modules/@strapi/review-workflows/dist/admin/chunks/index-Bwgyfg-u.mjs
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en-BixG7IBu-U3WDNEK5.js");
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-tE19YOje-PVUZ5JZN.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-CEP8kvxZ-A3DMFDC7.js");
          return {
...
//# sourceMappingURL=chunk-U5TENKND.js.map
