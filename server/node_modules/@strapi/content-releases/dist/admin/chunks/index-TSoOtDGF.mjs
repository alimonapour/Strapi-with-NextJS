     ...
     */ app.createHook('ContentReleases/pages/ReleaseDetails/add-locale-in-releases');
        if (window.strapi.features.isEnabled('cms-content-releases')) {
            app.addMenuLink({
                ...
                Component: ()=>import('./App-nCn9ijZP.mjs').then((mod)=>({
                            default: mod.App
                        })),
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { ProtectedReleasesSettingsPage } = await import('./ReleasesSettingsPage-BDN7ia8_.mjs');
                    return {
...
//# sourceMappingURL=index-TSoOtDGF.mjs.map
