     ...
     */ app.createHook('ContentReleases/pages/ReleaseDetails/add-locale-in-releases');
        if (window.strapi.features.isEnabled('cms-content-releases')) {
            app.addMenuLink({
                ...
                Component: ()=>Promise.resolve().then(function () { return require('./App-Ccfr_N2a.js'); }).then((mod)=>({
                            default: mod.App
                        })),
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { ProtectedReleasesSettingsPage } = await Promise.resolve().then(function () { return require('./ReleasesSettingsPage-DgUoq8_y.js'); });
                    return {
...
//# sourceMappingURL=index-BFXwEPqg.js.map
