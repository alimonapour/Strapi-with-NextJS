...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    ...
    case './translations/uk.json': return Promise.resolve().then(function () { return require('./uk-CbRUr1I7.js'); });
    ...
    register (app) {
        if (window.strapi.features.isEnabled(FEATURE_ID)) {
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { Router } = await Promise.resolve().then(function () { return require('./router-B0yP_sPs.js'); });
                    return {
                        default: Router
                    };
                }
...
//# sourceMappingURL=index-o5qgjdDk.js.map
