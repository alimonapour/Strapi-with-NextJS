        ...
        ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
            {
                path: 'audit-logs',
                lazy: async ()=>{
                    const { ProtectedListPage } = await import('./ListPage-CTxfjKUP.mjs');
                    return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
            {
                path: 'single-sign-on',
                lazy: async ()=>{
                    const { ProtectedSSO } = await import('./SingleSignOnPage-B-NIM66a.mjs');
                    return {
 ...
 * -----------------------------------------------------------------------------------------------*/ const AuthPage = ()=>{
    ...
    const { hasAdmin } = data ?? {};
    const Login$1 = useEnterprise(Login, async ()=>(await import('./Login-B_Z4SJVp.mjs')).LoginEE);
    const forms = useEnterprise(FORMS, async ()=>(await import('./constants-BY_PZgf3.mjs')).FORMS, {
...
const ROUTES_CE = [
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-BuFQNHRU.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-BO4p8eVo.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-CFSx_zaS.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-CovdXetq.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-DrT9bgfE.mjs');
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-CvMkpe3b.mjs');
            return {
                Component: ProtectedCreatePage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-CBrPs4kH.mjs').then(function (n) { return n.b; });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-BE3aimOU.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView-BUbdI3-z.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-h_bF5XrZ.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditViewPage-BLftPAqX.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-B5Rq5Uhw.mjs');
            return {
                Component: ProtectedCreateView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView-DxPGNDw_.mjs');
            return {
                Component: ProtectedListView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditView-XfGT5Bj1.mjs');
            return {
                Component: ProtectedEditView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedInstalledPlugins } = await import('./InstalledPlugins-23tOdYYB.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseAuditLogs } = await import('./PurchaseAuditLogs-BOqpGLyP.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseSingleSignOn } = await import('./PurchaseSingleSignOn-L8wgCpHG.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseContentHistory } = await import('./PurchaseContentHistory-DqyUHK_8.mjs');
            return {
 ...
 */ const getImmutableRoutes = ()=>[
        {
            path: 'usecase',
            lazy: async ()=>{
                const { PrivateUseCasePage } = await import('./UseCasePage-BlHgNz7W.mjs');
                return {
...
const getInitialRoutes = ()=>[
        {
            index: true,
            lazy: async ()=>{
                const { HomePage } = await import('./HomePage-BRggBAHf.mjs');
                return {
                    Component: HomePage
                };
            }
        },
        {
            path: 'me',
            lazy: async ()=>{
                const { ProfilePage } = await import('./ProfilePage-D0cczhuo.mjs');
                return {
        ...
        },
        {
            path: 'marketplace',
            lazy: async ()=>{
                const { ProtectedMarketplacePage } = await import('./MarketplacePage-BUksRtFV.mjs');
                return {
        ...
        },
        {
            path: 'settings/*',
            lazy: async ()=>{
                const { Layout } = await import('./Layout-CmzbGRtV.mjs');
                return {
                    Component: Layout
                };
            },
            children: [
                {
                    ...
                    lazy: async ()=>{
                        const { ApplicationInfoPage } = await import('./ApplicationInfoPage-BZwUO73O.mjs');
                        return {
        ...
        const routes = [
            {
                ...
                children: [
                    ...getImmutableRoutes(),
                    {
                        path: '/*',
                        lazy: async ()=>{
                            const { PrivateAdminLayout } = await import('./AuthenticatedLayout-jDyinb04.mjs');
                            return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case './translations/uk.json': return import('./uk-D7QEPfXn.mjs');
...
//# sourceMappingURL=index-C3BO0YZa.mjs.map
