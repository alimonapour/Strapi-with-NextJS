...
import { u as useField, w as useForm, x as MemoizedStringInput, F as Form, b as Layouts, B as BackButton, M as MemoizedInputRenderer } from './index-C3BO0YZa.mjs';
...
const WebhookForm = ({ handleSubmit, triggerWebhook, isCreating, isTriggering, triggerResponse, data })=>{
    ...
    const EventTable = useEnterprise(EventTableCE, async ()=>(await import('./EventsTable-aDYIp-4O.mjs')).EventsTableEE);
    /**
...
//# sourceMappingURL=EditPage-CBrPs4kH.mjs.map
