...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index-C3BO0YZa.mjs';
...
const useSettingsMenu = ()=>{
   ...
   */ const ceLinks = React.useMemo(()=>SETTINGS_LINKS_CE(), []);
    const { admin: adminLinks, global: globalLinks } = useEnterprise(ceLinks, async ()=>(await import('./index-C3BO0YZa.mjs').then(function (n) { return n.O; })).SETTINGS_LINKS_EE(), {
...
export { Layout };
//# sourceMappingURL=Layout-CmzbGRtV.mjs.map
