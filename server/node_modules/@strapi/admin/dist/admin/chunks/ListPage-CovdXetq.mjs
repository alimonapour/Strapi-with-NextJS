...
import { e as errorsTrads, q as useCreateUserMutation, F as Form, M as MemoizedInputRenderer, k as useAdminUsers, r as useDeleteManyUsersMutation, b as Layouts, S as SearchInput, s as Filters, T as Table, P as Pagination, C as ConfirmDialog } from './index-C3BO0YZa.mjs';
...
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-hAMu1PFv.mjs';
...
import './useAdminRoles-D68i2BI_.mjs';
...
const ModalForm = ({ onToggle })=>{
    ...
    const MagicLink = useEnterprise(MagicLinkCE, async ()=>(await import('./MagicLinkEE-Oh6er0ux.mjs')).MagicLinkEE);
...
const ListPage = ()=>{
    const UsersListPage = useEnterprise(ListPageCE, async ()=>// eslint-disable-next-line import/no-cycle
        (await import('./ListPage-DoR-NV6v.mjs')).UserListPageEE);
    // block rendering until the EE component is fully loaded
    if (!UsersListPage) {
        return null;
    }
...
//# sourceMappingURL=ListPage-CovdXetq.mjs.map
