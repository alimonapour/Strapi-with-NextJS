        ...
        ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
            {
                path: 'audit-logs',
                lazy: async ()=>{
                    const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-SVEmrFSg.js'); });
                    return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
            {
                path: 'single-sign-on',
                lazy: async ()=>{
                    const { ProtectedSSO } = await Promise.resolve().then(function () { return require('./SingleSignOnPage-D-JNyyk2.js'); });
                    return {
 ...
 * -----------------------------------------------------------------------------------------------*/ const AuthPage = ()=>{
    ...
    const { hasAdmin } = data ?? {};
    const Login$1 = useEnterprise.useEnterprise(Login, async ()=>(await Promise.resolve().then(function () { return require('./Login-CjRacmoJ.js'); })).LoginEE);
    const forms = useEnterprise.useEnterprise(FORMS, async ()=>(await Promise.resolve().then(function () { return require('./constants-D3gM8ElF.js'); })).FORMS, {
...
const ROUTES_CE = [
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-C46MNvAQ.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await Promise.resolve().then(function () { return require('./CreatePage-Bgs19RIr.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-85v6bKcJ.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-BRVhZryp.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-DHtr1mq1.js'); });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await Promise.resolve().then(function () { return require('./CreatePage-D0kjwP8s.js'); });
            return {
                Component: ProtectedCreatePage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-CK8pIRKZ.js'); }).then(function (n) { return n.EditPage$1; });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-fOcHewxm.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await Promise.resolve().then(function () { return require('./ListView-CGHuleNQ.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await Promise.resolve().then(function () { return require('./CreateView-DGq7e-Zm.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await Promise.resolve().then(function () { return require('./EditViewPage-Dvm8m28e.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await Promise.resolve().then(function () { return require('./CreateView-DCsm2KBZ.js'); });
            return {
                Component: ProtectedCreateView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await Promise.resolve().then(function () { return require('./ListView-HZFAPppY.js'); });
            return {
                Component: ProtectedListView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await Promise.resolve().then(function () { return require('./EditView-CfJxHMkF.js'); });
            return {
                Component: ProtectedEditView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedInstalledPlugins } = await Promise.resolve().then(function () { return require('./InstalledPlugins-z8ODfbJj.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseAuditLogs } = await Promise.resolve().then(function () { return require('./PurchaseAuditLogs-BIBa5E6F.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseSingleSignOn } = await Promise.resolve().then(function () { return require('./PurchaseSingleSignOn-DloQ-NfU.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseContentHistory } = await Promise.resolve().then(function () { return require('./PurchaseContentHistory-y25nmJsq.js'); });
            return {
 ...
 */ const getImmutableRoutes = ()=>[
        {
            path: 'usecase',
            lazy: async ()=>{
                const { PrivateUseCasePage } = await Promise.resolve().then(function () { return require('./UseCasePage-CYCPZztF.js'); });
                return {
...
const getInitialRoutes = ()=>[
        {
            index: true,
            lazy: async ()=>{
                const { HomePage } = await Promise.resolve().then(function () { return require('./HomePage-8CeDS3qO.js'); });
                return {
                    Component: HomePage
                };
            }
        },
        {
            path: 'me',
            lazy: async ()=>{
                const { ProfilePage } = await Promise.resolve().then(function () { return require('./ProfilePage-DghUK7p_.js'); });
                return {
        ...
        },
        {
            path: 'marketplace',
            lazy: async ()=>{
                const { ProtectedMarketplacePage } = await Promise.resolve().then(function () { return require('./MarketplacePage-D-PvEBXN.js'); });
                return {
        ...
        },
        {
            path: 'settings/*',
            lazy: async ()=>{
                const { Layout } = await Promise.resolve().then(function () { return require('./Layout-BZgwh-LZ.js'); });
                return {
                    Component: Layout
                };
            },
            children: [
                {
                    ...
                    lazy: async ()=>{
                        const { ApplicationInfoPage } = await Promise.resolve().then(function () { return require('./ApplicationInfoPage-DJOazrYK.js'); });
                        return {
        ...
        const routes = [
            {
                ...
                children: [
                    ...getImmutableRoutes(),
                    {
                        path: '/*',
                        lazy: async ()=>{
                            const { PrivateAdminLayout } = await Promise.resolve().then(function () { return require('./AuthenticatedLayout-Dy75FZrh.js'); });
                            return {
...
//# sourceMappingURL=index-BdqtLS-k.js.map
