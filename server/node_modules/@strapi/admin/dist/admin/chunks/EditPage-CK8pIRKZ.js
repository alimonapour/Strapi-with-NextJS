...
const WebhookForm = ({ handleSubmit, triggerWebhook, isCreating, isTriggering, triggerResponse, data })=>{
    ...
    const EventTable = useEnterprise.useEnterprise(EventTableCE, async ()=>(await Promise.resolve().then(function () { return require('./EventsTable-C1FNa1mh.js'); })).EventsTableEE);
    /**
...
//# sourceMappingURL=EditPage-CK8pIRKZ.js.map
