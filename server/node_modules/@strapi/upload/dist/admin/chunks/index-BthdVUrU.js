...
const admin = {
    register (app) {
        app.addMenuLink({
            ...
            Component: ()=>Promise.resolve().then(function () { return require('./App-B15JbrNJ.js'); }).then((mod)=>({
                        default: mod.Upload
                    })),
            position: 4
        });
        app.addSettingsLink('global', {
            ...
            async Component () {
                const { ProtectedSettingsPage } = await Promise.resolve().then(function () { return require('./SettingsPage-BzpO2fdA.js'); });
                return {
...
//# sourceMappingURL=index-BthdVUrU.js.map
