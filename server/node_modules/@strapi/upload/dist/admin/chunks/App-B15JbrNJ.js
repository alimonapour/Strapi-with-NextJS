...
var index = require('./index-BthdVUrU.js');
require('byte-size');
require('date-fns');
var qs = require('qs');
...
// TODO: find a better naming convention for the file that was an index file before
const ConfigureTheView = /*#__PURE__*/ React__namespace.lazy(async ()=>Promise.resolve().then(function () { return require('./ConfigureTheView-aK3m46Cs.js'); }).then((mod)=>({
...
//# sourceMappingURL=App-B15JbrNJ.js.map
