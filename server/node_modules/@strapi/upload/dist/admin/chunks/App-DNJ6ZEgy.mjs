...
// TODO: find a better naming convention for the file that was an index file before
const ConfigureTheView = /*#__PURE__*/ React.lazy(async ()=>import('./ConfigureTheView-BLXfYigZ.mjs').then((mod)=>({
...
export { Upload };
//# sourceMappingURL=App-DNJ6ZEgy.mjs.map
