...
const ListView = /*#__PURE__*/ lazy(()=>import('./ListView-C9TjGTm0.mjs'));
const App = ()=>{
    const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-Cb2nsEPf.mjs.map
