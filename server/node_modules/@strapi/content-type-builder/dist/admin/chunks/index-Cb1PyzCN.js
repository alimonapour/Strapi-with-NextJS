...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case './translations/uk.json': return Promise.resolve().then(function () { return require('./uk-felSA_eV.js'); });
...
var index = {
    register (app) {
        ...
        app.addMenuLink({
            ...
            Component: ()=>Promise.resolve().then(function () { return require('./index-DSPLhbfR.js'); }).then(function (n) { return n.index; }),
            position: 5
        });
        app.registerPlugin({
            id: pluginId,
...
//# sourceMappingURL=index-Cb1PyzCN.js.map
